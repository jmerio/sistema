        ...
        <nav class="navbar-color gradient-45deg-light-blue-cyan">
          <div class="nav-wrapper">
              ...
              <li>
                <h1 class="logo-wrapper">
                  <a href="index.html" class="brand-logo darken-1">
                    <span class="logo-text hide-on-med-and-down">SGA</span>
                  </a>
                </h1>
              </li>
            </ul>
            <div class="header-search-wrapper hide-on-med-and-down">
              ...
              <input type="text" name="Search" class="header-search-input z-depth-2" placeholder="Buscar en el sistema" />
            </div>
          ...
          <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="no-padding">
              <ul class="collapsible" data-collapsible="accordion">
                ...
                <li class="bold">
                  <a href="notas.html" class="waves-effect waves-cyan">
                      <i class="material-icons">insert_link</i>
                      <span class="nav-text">Notas</span>
                    </a>
                </li>
                <li class="bold">
                  <a href="padres.html" class="waves-effect waves-cyan">
                      <i class="material-icons">format_color_text</i>
                      <span class="nav-text">Padres de Familia</span>
                    </a>
                </li>
                <li class="bold">
                  <a href="cursos.html" class="waves-effect waves-cyan">
                      <i class="material-icons">format_size</i>
                      <span class="nav-text">Cursos</span>
                    </a>
                </li>
                <li class="bold">
                  <a href="matricula.html" class="waves-effect waves-cyan">
                      <i class="material-icons">invert_colors</i>
                      <span class="nav-text">Matrícula</span>
                    </a>
                </li>
                <li class="bold">
                  <a href="profesores.html" class="waves-effect waves-cyan">
                      <i class="material-icons">border_all</i>
                      <span class="nav-text">Profesores</span>
                    </a>
                </li>
                <li class="bold">
                  <a href="materias.html" class="waves-effect waves-cyan">
